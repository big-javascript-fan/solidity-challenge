...
contract Staker is Ownable {
    ...
    event depositFinished(address indexed user, uint256 amount);
     ...
     * @return uint256 The amount of tokens.
     */
    function depositOf(address _stakeholder) public view returns (uint256) {
     ...
     */
    function getTotaldepositdAmount() public view returns (uint256) {
        return totaldepositdAmount;
    }
